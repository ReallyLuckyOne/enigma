...
/***/ "./src/assets/js/form__valid-comment.js":
/*!**********************************************!*\
  !*** ./src/assets/js/form__valid-comment.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\r\n\r\ndocument.addEventListener('DOMContentLoaded', function () {\r\n\r\n    const form = document.getElementById('form-con');\r\n    form.addEventListener('submit', formSend);\r\n    \r\n    async function formSend(e) {\r\n        e.preventDefault();\r\n        \r\n        let error = formValidate(form);\r\n        \r\n        if (error === 0) {\r\n            alert('Воу, воу. Ти хто такий? Той самий син маминої подруги?? Не полінувався рандомно заповнити всі поля, аааа');\r\n        } else {\r\n            alert('Хмм, цікаво чи багато людей потицькало сюди, щоб перевірити чи шось станеться, ахаха');\r\n        }\r\n    }\r\n    \r\n    function formValidate(form) {\r\n    \r\n        let error = 0;\r\n        let formReq = document.querySelectorAll('._req');\r\n        \r\n        for (let index = 0; index < formReq.length; index++) {\r\n        \r\n            const input = formReq[index];\r\n            formRemoveError(input);\r\n            \r\n            if(input.classList.contains('_email')) {\r\n            \r\n                if(emailTest(input)) {\r\n                \r\n                    formAddError(input);\r\n                    error++;\r\n                }            \r\n            } else {\r\n                \r\n                    if(input.value === '') {\r\n                    \r\n                        formAddError(input);\r\n                        error++;\r\n                    }\r\n                }\r\n\r\n        }\r\n        return error;\r\n    }\r\n    \r\n    function formAddError(input) {\r\n    \r\n        input.parentElement.classList.add('_error');\r\n        input.classList.add('_error');\r\n    }\r\n    function formRemoveError(input) {\r\n    \r\n        input.parentElement.classList.remove('_error');\r\n        input.classList.remove('_error');\r\n    }\r\n        function emailTest(input) {\r\n    \r\n        return !/^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,8})+$/.test(input.value);\r\n    }\r\n});\n\n//# sourceURL=webpack:///./src/assets/js/form_validateContact.js?");
